...
const LinkBox = ({Icon, href}) =>{
    ...
    return (
        ...
        >
            ...
            <Icon className="text-xl sm:text-3xl md:text-4xl text-neutral-900 dark:text-shade"/>

            {/*overlay div*/}
            <div
                ref={scope}
                style={{clipPath:BOTTOM_RIGHT_CLIP}}
                className="absolute inset-0 grid place-content-center bg-neutral-900 dark:bg-shade">
                <Icon className="text-xl sm:text-3xl md:text-4xl text-primary dark:text-neutral-900"/>
            </div>
        </a>
    );
};
...
const ClipPathLinks = () => {
    return(
        <div className="border border-neutral-900 divide-y divide-neutral-900 dark:divide-shade dark:border-shade">
            <div className="grid grid-cols-3 divide-x divide-neutral-900 dark:divide-shade">
                <LinkBox Icon={TbBrandReact} href="" />
                <LinkBox Icon={SiTailwindcss} href="" />
                <LinkBox Icon={TbBrandNextjs} href="" />
            </div>

            <div className="grid grid-cols-4 divide-x divide-neutral-900 dark:divide-shade">
